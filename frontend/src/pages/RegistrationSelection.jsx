...
export default function RegistrationSelectionWithNav() {
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-semibold text-gray-900 mb-2">Join Us</h1>
            <p className="text-gray-600">Select how you'd like to register</p>
          </div>

  ...
  const handleSubmit = async (e) => {
    ...
    if (otp.join('').length === 6) {
      ...
      try {
        ...
        showNotification('success', 'Email verification successful!');
        ...
        if (errorStatus === 'EXPIRED') {
          showNotification('error', 'Your OTP has expired or is invalid. Please request a new one.');
        } else if (errorStatus === 'INVALID') {
          showNotification('error', 'Invalid OTP. Please check and try again.');
        } else {
